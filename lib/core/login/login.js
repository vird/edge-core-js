...
export function makeLoginTree(
  ...
  return updateTree(
    ...
    (stash, children) => {
      const login = filterObject(stash, [
        'username',
        'appId',
        'loginId'
      ])
 ...
 */
export function sanitizeLoginStash(stashTree, appId) {
  return updateTree(
    stashTree,
    stash => stash.appId === appId,
    stash => stash,
 ...
 */
export function applyKit(ai, loginTree, kit) {
...
export async function syncAccount(ai, accountId) {
